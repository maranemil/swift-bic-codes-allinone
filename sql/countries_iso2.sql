...
--
-- Host: localhost
-- Generation Time: Sep 25, 2019 at 05:31 PM
...
--
-- Database: `swift-bic-codes`
--

-- --------------------------------------------------------

--
-- Table structure for table `countries_iso2`
--

CREATE TABLE `countries_iso2` (
  `name` varchar(52) DEFAULT NULL,
  `alpha2` varchar(7) DEFAULT NULL,
  `alpha3` varchar(7) DEFAULT NULL,
  `country-code` varchar(12) DEFAULT NULL,
  `iso3166` varchar(13) DEFAULT NULL,
  `region` varchar(8) DEFAULT NULL,
  `subregion` varchar(31) DEFAULT NULL,
  `int-region` varchar(19) DEFAULT NULL,
  `region-code` varchar(11) DEFAULT NULL,
  `sub-region-code` varchar(15) DEFAULT NULL,
  `int-region-code` varchar(24) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `countries_iso2`
--

INSERT INTO `countries_iso2` (`name`, `alpha2`, `alpha3`, `country-code`, `iso3166`, `region`, `subregion`, `int-region`, `region-code`, `sub-region-code`, `int-region-code`) VALUES
